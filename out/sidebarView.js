...
exports.HelloCigenSidebarViewProvider = void 0;
const vscode = __importStar(require("vscode"));
const CHOICE_KEY = "helloCigen.userChoice";
class HelloCigenSidebarViewProvider {
    context;
    chatManager;
    ...
    async launch() {
        const choice = this.context.globalState.get(CHOICE_KEY);
        if (!choice) {
            await this.openChoiceTilesPanel({ openChatAfter: false });
            return;
        }
...
<body>
  ...
  <script>
    ...
    async openChoiceTilesPanel(opts) {
        const panel = vscode.window.createWebviewPanel("helloCigen.modePicker", "Choose a mode", vscode.ViewColumn.Active, { enableScripts: true });
        ...
        const existing = this.context.globalState.get(CHOICE_KEY);
...
exports.HelloCigenSidebarViewProvider = HelloCigenSidebarViewProvider;
